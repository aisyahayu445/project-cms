                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="row">
                                                    <div class="col mb-3">
                                                        <label class="form-label">Harga</label>
                                                        <input type="text" class="form-control" value="<?= $aa['harga'] ?>" name="harga" />
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col mb-3">
                                                        <label class="form-label">Alamat</label>
                                                        <textarea name="alamat" class="form-control"><?= $aa['alamat'] ?> </textarea>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col mb-3">
                                                        <label class="form-label">Jam Operasional</label>
                                                        <textarea name="jam operasional" class="form-control"><?= $aa['jam_operasional'] ?> </textarea>
                                                    </div>
                                                </div>
                                                <div class=" row">
                                                    <div class="col mb-3">
